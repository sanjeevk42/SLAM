    ...
    def _point_cloud(self, depth_image, dataset_int):
        ...
        for v in range(depth_image.shape[0]):
            for u in range(depth_image.shape[1]):
                ...
                pointcloud[index, 2] = depth_image[v, u] / self.FACTOR
                pointcloud[index, 0] = (u - self.CX[dataset_int-1]) * pointcloud[index, 2] / self.FX[dataset_int-1]
                pointcloud[index, 1] = (v - self.CY[dataset_int-1]) * pointcloud[index, 2] / self.FY[dataset_int-1]
